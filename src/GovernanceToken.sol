...
contract GovernanceToken is ERC20, ERC20Permit, ERC20Votes, Ownable {
    ...
    constructor(address _vestingContract, address _treasury, address _communityAirdrop, address _liquidityPool)
        ...
        Ownable(msg.sender)
    {
        ...
        emit TokensDistributed(_vestingContract, _treasury, _communityAirdrop, _liquidityPool);
    }
